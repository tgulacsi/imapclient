...
// MailFoldersItemChildFoldersItemCopyRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\copy
...
// NewMailFoldersItemChildFoldersItemCopyRequestBuilderInternal instantiates a new MailFoldersItemChildFoldersItemCopyRequestBuilder and sets the default values.
func NewMailFoldersItemChildFoldersItemCopyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MailFoldersItemChildFoldersItemCopyRequestBuilder) {
    m := &MailFoldersItemChildFoldersItemCopyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/copy", pathParameters),
    }
    return m
}
// NewMailFoldersItemChildFoldersItemCopyRequestBuilder instantiates a new MailFoldersItemChildFoldersItemCopyRequestBuilder and sets the default values.
...
func (m *MailFoldersItemChildFoldersItemCopyRequestBuilder) WithUrl(rawUrl string)(*MailFoldersItemChildFoldersItemCopyRequestBuilder) {
    return NewMailFoldersItemChildFoldersItemCopyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
