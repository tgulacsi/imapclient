...
// MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\messages\{message-id}\createForward
...
// NewMailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilderInternal instantiates a new MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder and sets the default values.
func NewMailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder) {
    m := &MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createForward", pathParameters),
    }
    return m
}
// NewMailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder instantiates a new MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder and sets the default values.
...
func (m *MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder) WithUrl(rawUrl string)(*MailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder) {
    return NewMailFoldersItemChildFoldersItemMessagesItemCreateForwardRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
