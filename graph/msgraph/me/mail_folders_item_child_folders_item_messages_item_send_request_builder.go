...
// MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\childFolders\{mailFolder-id1}\messages\{message-id}\send
...
// NewMailFoldersItemChildFoldersItemMessagesItemSendRequestBuilderInternal instantiates a new MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder and sets the default values.
func NewMailFoldersItemChildFoldersItemMessagesItemSendRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder) {
    m := &MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/send", pathParameters),
    }
    return m
}
// NewMailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder instantiates a new MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder and sets the default values.
...
func (m *MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder) WithUrl(rawUrl string)(*MailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder) {
    return NewMailFoldersItemChildFoldersItemMessagesItemSendRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
