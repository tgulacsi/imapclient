...
// MailFoldersItemMessagesDeltaRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\messages\delta()
...
// NewMailFoldersItemMessagesDeltaRequestBuilderInternal instantiates a new MailFoldersItemMessagesDeltaRequestBuilder and sets the default values.
func NewMailFoldersItemMessagesDeltaRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MailFoldersItemMessagesDeltaRequestBuilder) {
    m := &MailFoldersItemMessagesDeltaRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,changeType*}", pathParameters),
    }
    return m
}
// NewMailFoldersItemMessagesDeltaRequestBuilder instantiates a new MailFoldersItemMessagesDeltaRequestBuilder and sets the default values.
...
// returns a MailFoldersItemMessagesDeltaResponseable when successful
...
func (m *MailFoldersItemMessagesDeltaRequestBuilder) Get(ctx context.Context, requestConfiguration *MailFoldersItemMessagesDeltaRequestBuilderGetRequestConfiguration)(MailFoldersItemMessagesDeltaResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateMailFoldersItemMessagesDeltaResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
// returns a MailFoldersItemMessagesDeltaGetResponseable when successful
// returns a ODataError error when the service returns a 4XX or 5XX status code
// [Find more info here]
// 
// [Find more info here]: https://learn.microsoft.com/graph/api/message-delta?view=graph-rest-1.0
func (m *MailFoldersItemMessagesDeltaRequestBuilder) GetAsDeltaGetResponse(ctx context.Context, requestConfiguration *MailFoldersItemMessagesDeltaRequestBuilderGetRequestConfiguration)(MailFoldersItemMessagesDeltaGetResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateMailFoldersItemMessagesDeltaGetResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(MailFoldersItemMessagesDeltaGetResponseable), nil
}
...
func (m *MailFoldersItemMessagesDeltaRequestBuilder) WithUrl(rawUrl string)(*MailFoldersItemMessagesDeltaRequestBuilder) {
    return NewMailFoldersItemMessagesDeltaRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
