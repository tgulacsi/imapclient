...
// MailFoldersItemMessagesItemSendRequestBuilder builds and executes requests for operations under \me\mailFolders\{mailFolder-id}\messages\{message-id}\send
...
// NewMailFoldersItemMessagesItemSendRequestBuilderInternal instantiates a new MailFoldersItemMessagesItemSendRequestBuilder and sets the default values.
func NewMailFoldersItemMessagesItemSendRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MailFoldersItemMessagesItemSendRequestBuilder) {
    m := &MailFoldersItemMessagesItemSendRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/send", pathParameters),
    }
    return m
}
// NewMailFoldersItemMessagesItemSendRequestBuilder instantiates a new MailFoldersItemMessagesItemSendRequestBuilder and sets the default values.
...
func (m *MailFoldersItemMessagesItemSendRequestBuilder) WithUrl(rawUrl string)(*MailFoldersItemMessagesItemSendRequestBuilder) {
    return NewMailFoldersItemMessagesItemSendRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
