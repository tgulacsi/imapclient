...
// MessagesItemExtensionsCountRequestBuilder builds and executes requests for operations under \me\messages\{message-id}\extensions\$count
...
// NewMessagesItemExtensionsCountRequestBuilderInternal instantiates a new MessagesItemExtensionsCountRequestBuilder and sets the default values.
func NewMessagesItemExtensionsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MessagesItemExtensionsCountRequestBuilder) {
    m := &MessagesItemExtensionsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/me/messages/{message%2Did}/extensions/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewMessagesItemExtensionsCountRequestBuilder instantiates a new MessagesItemExtensionsCountRequestBuilder and sets the default values.
...
func (m *MessagesItemExtensionsCountRequestBuilder) WithUrl(rawUrl string)(*MessagesItemExtensionsCountRequestBuilder) {
    return NewMessagesItemExtensionsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
