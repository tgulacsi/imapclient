...
// ByMessageRuleId gets an item from the github.com/tgulacsi/imapclient/graph/msgraph.users.item.mailFolders.item.childFolders.item.messageRules.item collection
