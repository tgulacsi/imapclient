...
// ItemMailFoldersItemMoveRequestBuilder builds and executes requests for operations under \users\{user-id}\mailFolders\{mailFolder-id}\move
...
func (m *ItemMailFoldersItemMoveRequestBuilder) Post(ctx context.Context, body ItemMailFoldersItemMovePostRequestBodyable, requestConfiguration *ItemMailFoldersItemMoveRequestBuilderPostRequestConfiguration)(i992b4a960d2aac6ee675fd11b0e2cdb20526c4d5f58b360b5923c6d853233698.MailFolderable, error) {
