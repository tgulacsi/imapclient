...
// ItemMessagesItemAttachmentsCreateUploadSessionRequestBuilder builds and executes requests for operations under \users\{user-id}\messages\{message-id}\attachments\createUploadSession
