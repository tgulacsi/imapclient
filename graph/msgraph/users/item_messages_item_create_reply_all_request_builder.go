...
// ItemMessagesItemCreateReplyAllRequestBuilder builds and executes requests for operations under \users\{user-id}\messages\{message-id}\createReplyAll
...
func (m *ItemMessagesItemCreateReplyAllRequestBuilder) Post(ctx context.Context, body ItemMessagesItemCreateReplyAllPostRequestBodyable, requestConfiguration *ItemMessagesItemCreateReplyAllRequestBuilderPostRequestConfiguration)(i992b4a960d2aac6ee675fd11b0e2cdb20526c4d5f58b360b5923c6d853233698.Messageable, error) {
